          ...
          <div class="card-body">
            {{-- <form method="POST" action="{{ route('role.store') }}"> --}}
                            ...
                            <td>
                              ...
                              @else
                                <div class="form-check">
                                  ...
                                  {{ !empty($permissionsAccount->contains('name', $modul->name." view")) ? 'checked' : '' }} >
                                </div>
                              @endif
                            </td>
                            <td>
                              ...
                              @else
                                <div class="form-check">
                                  ...
                                  {{ !empty($permissionsAccount->contains('name', $modul->name." detail")) ? 'checked' : '' }} >
                                </div>
                              @endif
                            </td>
                            <td>
                              ...
                              @else
                                <div class="form-check">
                                  ...
                                  {{ !empty($permissionsAccount->contains('name', $modul->name." create")) ? 'checked' : '' }} >
                                </div>
                              @endif
                            </td>
                            <td>
                              ...
                              @else
                                <div class="form-check">
                                  ...
                                  {{ !empty($permissionsAccount->contains('name', $modul->name." edit")) ? 'checked' : '' }} >
                                </div>
                              @endif
                            </td>
                            <td>
                              ...
                              @else
                                <div class="form-check">
                                  ...
                                  {{ !empty($permissionsAccount->contains('name', $modul->name." delete")) ? 'checked' : '' }} >
                                </div>
                              @endif
                            </td>
                            <td>
                              ...
                              @else
                                <div class="form-check">
                                  ...
                                  {{ !empty($permissionsAccount->contains('name', $modul->name." export")) ? 'checked' : '' }} >
                                </div>
                              @endif
                            </td>
                            <td>
                              ...
                              @else
                                <div class="form-check">
                                  ...
                                  {{ !empty($permissionsAccount->contains('name', $modul->name." import")) ? 'checked' : '' }} >
                                </div>
                              @endif
                            </td>
                          </tr>
              ...
              <div class="mt-2">
                ...
                <a href="{{ route('role.reset-permission', $role->id) }}" class="btn btn-danger">Reset</a>
              </div>
            </form>
          </div>
          <!-- /Form -->
