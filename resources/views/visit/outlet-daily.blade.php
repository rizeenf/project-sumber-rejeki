...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h5>Tabel Gerai dan Produk yang Dipakai</h5>
                <div class="card-header-action">
                    ...
                    <a href="{{ route('visit.detail-store-daily', ['date' => $headerVisit->date, 'user' => $headerVisit->user_id]) }}" class="btn btn-secondary"><box-icon name='plus' ></box-icon> Display Toko</a>
                </div>
            </div>
        </div>
        <div class="card-body">
