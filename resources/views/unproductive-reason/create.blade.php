    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card mb-4">
          ...
          <!-- Form -->
          <div class="card-body">
            <form method="POST" action="{{ route('unproductive-reason.store') }}">
                @csrf
              <div class="row">
                ...
                <div class="col-md mb-2">
                  ...
                  <div class="form-check form-check-inline mt-3">
                    <input class="form-check-input" type="radio" id="type" value="S" name="type">
                    <label class="form-check-label" for="inlineRadio1">Toko</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="type" value="O" name="type">
