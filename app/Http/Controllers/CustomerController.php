...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(empty($request->owner_name)){
            toastr()->warning('Pelanggan yang ditambahkan tidak memiliki data pemilik');
    ...
    public function edit(string $id)
    {
        ...
        return view('customer.edit', compact('customer', 'branches', 'owner'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response(['status' => 'success', 'message' => 'Pelanggan berhasil dihapus']);
    }

    public function trashed(CustomerTrashedDataTable $dataTable){
        return $dataTable->render('customer.trashed');
    }
    ...
    public function restore($id){
        ...
        toastr()->success('Pelanggan berhasil dikembalikan');
    ...
    public function forceDelete($id){
        ...
        return response(['status' => 'success', 'message' => 'Pelanggan berhasil dihapus permanen']);
    }
