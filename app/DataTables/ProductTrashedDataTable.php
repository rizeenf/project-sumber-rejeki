...
class ProductTrashedDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function($query){
                ...
                $btnEdit = "<a class='btn btn-info' href='".route('product.restore', $query->id)."'>Kembalikan </a>";
                $btnDelete = "<a class='btn btn-danger delete-item' href='".route('product.force-delete', $query->id)."'>Hapus Permanen</a>";
    ...
    {
        return $this->builder()
                    ->setTableId('producttrashed-table')
    ...
    {
        return 'ProductTrashed_' . date('YmdHis');
    }
}
