...
class StoreTrashedDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function($query){
                ...
                $btnEdit = "<a class='btn btn-info' href='".route('store.restore', $query->id)."'>Kembalikan </a>";
                $btnDelete = "<a class='btn btn-danger delete-item' href='".route('store.force-delete', $query->id)."'>Hapus Permanen</a>";
    ...
    {
        return $model->newQuery()->onlyTrashed()->where('type' ,'S');
    }
