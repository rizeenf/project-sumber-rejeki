...
class DisplayProductTrashedDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addIndexColumn()
            ->addColumn('action', function($query){
                ...
                $btnEdit = "<a class='btn btn-info' href='".route('display.restore', $query->id)."'>Kembalikan </a>";
                $btnDelete = "<a class='btn btn-danger delete-item' href='".route('display.force-delete', $query->id)."'>Hapus Permanen</a>";
    ...
    {
        return $this->builder()
                    ->setTableId('displayproducttrashed-table')
    ...
    {
        return 'DisplayProductTrashed_' . date('YmdHis');
    }
}
