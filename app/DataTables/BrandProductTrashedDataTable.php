...
class BrandProductTrashedDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function($query){
                ...
                $btnEdit = "<a class='btn btn-info' href='".route('brand.restore', $query->id)."'>Kembalikan </a>";
                $btnDelete = "<a class='btn btn-danger delete-item' href='".route('brand.force-delete', $query->id)."'>Hapus Permanen</a>";
    ...
    {
        return $this->builder()
                    ->setTableId('brandproducttrashed-table')
    ...
    {
        return 'BrandProductTrashed_' . date('YmdHis');
    }
}
